...
namespace WPF.MDI
{
    ...
    public class MdiContainer : UserControl
    {
        ...
        public ThemeType Theme
        {
            get
            {
                return (ThemeType)GetValue(ThemeProperty);
            }
            set
            {
        ...
        public UIElement Menu
        {
            get
            {
                return (UIElement)GetValue(MenuProperty);
            }
            set
            {
        ...
        public MdiLayout MdiLayout
        {
            get
            {
                return (MdiLayout)GetValue(MdiLayoutProperty);
            }
            set
            {
                SetValue(MdiLayoutProperty, value);
            }
        }
        ...
        public MdiChild ActiveMdiChild
        {
            get
            {
                return (MdiChild)GetValue(ActiveMdiChildProperty);
            }
            internal set
            {
                SetValue(ActiveMdiChildProperty, value);
            }
        }
        ...
        internal Panel Buttons
        {
            get
            {
                return (Panel)GetValue(ButtonsProperty);
            }
            set
            {
        ...
        internal double InnerHeight
        {
            get
            {
                return ActualHeight - _topPanel.ActualHeight;
            }
        }
