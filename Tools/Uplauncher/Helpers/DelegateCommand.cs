...
namespace Uplauncher.Helpers
{
    /// <inheritdoc />
    /// <summary>
    /// Provides an <see cref="M:Uplauncher.Helpers.DelegateCommand.Execute(System.Object)" /> implementation which relays the <see cref="M:Uplauncher.Helpers.DelegateCommand.CanExecute(System.Object)" /> and <see cref="T:System.Windows.Input.ICommand" /> 
        ...
        public event EventHandler CanExecuteChanged
        {
            ...
            remove
            {
                ...
                for (int i = m_weakHandlers.Count - 1; i >= 0; i--)
                {
                    ...
                    if (!(weakReference.Target is EventHandler handler) || handler == value)
                    {
