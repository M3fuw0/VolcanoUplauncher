namespace DiscordRPC.Message
{
	...
	public enum MessageType
    {
	    ...
	    /// <summary>
	    ///     The connection to the Discord Client is lost. The connection will remain close and unready to accept messages until
	    ///     the Ready event is called again.
	    /// </summary>
	    Close,

	    /// <summary>
	    ///     A error has occured during the transmission of a message. For example, if a bad Rich Presence payload is sent, this
	    ///     event will be called explaining what went wrong.
	    /// </summary>
	    Error,
