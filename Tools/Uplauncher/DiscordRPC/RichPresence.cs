...
namespace DiscordRPC
{
    ...
    public class BaseRichPresence
    {
        ...
        /// <summary>
        ///     The party the player is currently in. The <see cref="Party.ID" /> must be set for this to be included in the
        ///     RichPresence update.
        /// </summary>
        ...
        /// <summary>
        ///     The secrets used for Join / Spectate. Secrets are obfuscated data of your choosing. They could be match ids, player
        ///     ids, lobby ids, etc. Make this object null if you do not wish too / unable too implement the Join / Request
        ///     feature.
        ///     <para>
        ///         To keep security on the up and up, Discord requires that you properly
        ///         hash/encode/encrypt/put-a-padlock-on-and-swallow-the-key-but-wait-then-how-would-you-open-it your secrets.
        ///     </para>
        ///     <para>
        ///         Visit the
        ///         <see href="https://discordapp.com/developers/docs/rich-presence/how-to#secrets">Rich Presence How-To</see> for
        ///         more information.
        ///     </para>
        /// </summary>
        ...
        /// <summary>
        ///     Marks the <see cref="Secrets.MatchSecret" /> as a game session with a specific beginning and end. It was going to
        ///     be used as a form of notification, but was replaced with the join feature. It may potentially have use in the
        ///     future, but it currently has no use.
        ///     <para>
        ///         "TLDR it marks the matchSecret field as an instance, that is to say a context in game that’s not like a lobby
        ///         state/not in game state. It was gonna he used for notify me, but we scrapped that for ask to join. We may put
        ///         it to another use in the future. For now, don’t worry about it" - Mason (Discord API Server 14 / 03 / 2018)
        ///     </para>
        /// </summary>
        ...
        /// <summary>
        ///     Attempts to call <see cref="StringTools.GetNullOrString(string)" /> on the string and return the result, if its
        ///     within a valid length.
        /// </summary>
...
#pragma warning restore CS0618 // Type or member is obsolete
    ...
    ///     </para>
    ///     <para>
    ///         You should send discord data that someone else's game client would need to join or spectate their friend. If
    ///         you can't or don't want to support those actions, you don't need to send secrets.
    ///     </para>
    ///     <para>
    ///         Visit the
    ///         <see href="https://discordapp.com/developers/docs/rich-presence/how-to#secrets">Rich Presence How-To</see> for
    ...
    public class Secrets
    {
        ...
        /// <summary>
        ///     The unique match code to distinguish different games/lobbies. Use <see cref="Secrets.CreateSecret(Random)" /> to
        ///     get an appropriately sized secret.
        ...
        /// </summary>
        [Obsolete(
            "This feature has been deprecated my Mason in issue #152 on the offical library. Was originally used as a Notify Me feature, it has been replaced with Join / Spectate.")]
        ...
        /// <summary>
        ///     The secret data that will tell the client how to connect to the game to play. This could be a unique identifier for
        ///     a fancy match maker or player id, lobby id, etc.
        ///     <para>
        ///         It is recommended to encrypt this information so its hard for people to replicate it.
        ...
        /// <summary>
        ///     The secret data that will tell the client how to connect to the game to spectate. This could be a unique identifier
        ///     for a fancy match maker or player id, lobby id, etc.
        ///     <para>
        ///         It is recommended to encrypt this information so its hard for people to replicate it.
        ///         Do <b>NOT</b> just use the IP address in this. That is a bad practice and can leave your players vulnerable!
        ///     </para>
        ...
        /// <summary>
        ///     Creates a new secret. This is NOT a cryptographic function and should NOT be used for sensitive information. This
        ///     is mainly provided as a way to generate quick IDs.
        /// </summary>
        /// <param name="random">The random to use</param>
        /// <returns>
        ///     Returns a <see cref="SecretLength" /> sized string with random characters from <see cref="Encoding" />
        /// </returns>
        ...
        /// <summary>
        ///     Creates a secret word using more readable friendly characters. Useful for debugging purposes. This is not a
        ///     cryptographic function and should NOT be used for sensitive information.
        /// </summary>
    ...
    public class Assets
    {
        ...
        /// <summary>
        ///     The ID of the large image. This is only set after Update Presence and will automatically become null when
        ///     <see cref="LargeImageKey" /> is changed.
        /// </summary>
        [JsonIgnore]
        public ulong? LargeImageID { get; private set; }

        /// <summary>
        ///     The ID of the small image. This is only set after Update Presence and will automatically become null when
        ///     <see cref="SmallImageKey" /> is changed.
        /// </summary>
        [JsonIgnore]
    ...
    public class Timestamps
    {
        ...
        /// <summary>
        ///     The time that match started. When included (not-null), the time in the rich presence will be shown as "00:01
        ///     elapsed".
        /// </summary>
        [JsonIgnore]
        ...
        /// <summary>
        ///     The time the match will end. When included (not-null), the time in the rich presence will be shown as "00:01
        ///     remaining". This will override the "elapsed" to "remaining".
        /// </summary>
        [JsonIgnore]
    ...
    public class Party
    {
        ...
        /// <summary>
        ///     A unique ID for the player's current party / lobby / group. If this is not supplied, they player will not be in a
        ///     party and the rest of the information will not be sent.
        ///     <para>Max 128 Bytes</para>
        /// </summary>
        ...
        /// <summary>
        ///     The maxium size of the party / lobby / group. This is required to be larger than <see cref="Size" />. If it is
        ///     smaller than the current party size, it will automatically be set too <see cref="Size" /> when the presence is
        ///     sent.
        /// </summary>
        [JsonIgnore]
        ...
        /// </summary>
        [JsonProperty("privacy", NullValueHandling = NullValueHandling.Include,
    ...
    public class Button
    {
        ...
        public string Url
        {
            ...
            set
            {
                ...
                if (!Uri.TryCreate(_url, UriKind.Absolute,
                        out var uriResult)) // || !(uriResult.Scheme == Uri.UriSchemeHttp || uriResult.Scheme == Uri.UriSchemeHttps))
    ...
    /// <summary>
    ///     The Rich Presence structure that will be sent and received by Discord. Use this class to build your presence and
    ...
    public sealed class RichPresence : BaseRichPresence
    {
        ...
        /// <summary>
        ///     Clones the presence into a new instance. Used for thread safe writing and reading. This function will ignore
        ///     properties if they are in a invalid state.
        /// </summary>
        /// <returns></returns>
            ...
            return new RichPresence
            {
                ...
                Secrets = !HasSecrets()
                    ...
                    : new Secrets
                    {
                        ...
                        SpectateSecret = Secrets.SpectateSecret != null
                            ? Secrets.SpectateSecret.Clone() as string
                            : null
                    },
